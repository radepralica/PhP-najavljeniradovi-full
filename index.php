                    ...
                    <tbody>
                        ...
                        <?php foreach ($results as $result) : ?>
                            <tr class="bg-<?php
                                ...
                                <td style="width:9rem;padding-top:2rem"><?php echo date("d.m.Y H:i", strtotime($result['pocetak'])); ?></td>





                                <td style="width:9rem;padding-top:2rem"><?php echo date("d.m.Y H:i", strtotime($result['trajanje'])); ?></td>
                                <td><?php echo $result['komentar']; ?></td>
                                <td style="display:inline-flex;">

                                    <button name="Edit" class="btn  btn-warning m-2"><a class="text-decoration-none text-white" href="./components/edit.php?id=<?php echo $result['id']; ?>">Edit</a></button>
                                    <button name="Delete" class="btn btn-sm btn-danger m-2"><a class="text-decoration-none text-white" href="./components/delete.php?id=<?php echo $result['id']; ?>">Delete</a></button>
                                </td>
                            </tr>
